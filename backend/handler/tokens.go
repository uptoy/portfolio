...
func (h *Handler) Tokens(c *gin.Context) {
	...
	if os.Getenv("ENV") == "production" {
		c.SetCookie("token", accessTokenNew, 60*60*24, "/", "https://backend-kighwilmrq-an.a.run.app", false, true)
		c.SetCookie("refreshToken", refreshTokenNew, 60*60*24*30, "/", "https://backend-kighwilmrq-an.a.run.app", false, true)
	}
