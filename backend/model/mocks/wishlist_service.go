...
func (m *MockWishlistService) WishlistCreate(ctx context.Context, userId uuid.UUID) (*model.Wishlist, error) {
...
func (m *MockWishlistService) WishlistDeleteItem(ctx context.Context, userId uuid.UUID, productId int64) ([]*model.Product, error) {
	ret := m.Called(ctx, userId, productId)
	var r0 []*model.Product
	if ret.Get(0) != nil {
		r0 = ret.Get(0).([]*model.Product)
