  ...
  return (
    <>
      <TableRow key={product.id}>
        ...
        <TableCell align="center"  className={classes.cell}>{product.category_id}</TableCell>
        <TableCell align="center"  className={classes.cell}>{product.price}</TableCell>
        <TableCell className={classes.cell}>{product.brand}</TableCell>
        <TableCell align="center"  className={classes.cell}>{product.count_in_stock}</TableCell>
