...
//     axios
//       .get(`${process.env.REACT_APP_PUBLIC_API_URL}/likes/like-unlike/${likedId}`, {
//         headers: {
...
//         } else {
//           const indexToModify = _.keys(_.pickBy(suggestionsResult, { visitor: likedId }))
...
//             }
//           })
//           document.querySelectorAll(`[visitor*="${likedId}"]`).forEach((element) => {
...
//   const handleSort = (event: any, profiles = suggestionsResult) => {
//     let sortChoice = ''
//     if (event) {
...
//   const handleChangeSlider = (type: any, newValue: any) => {
//     if (type === 'interests') {
//       newValue = newValue.map((interest: any) => {
...
//     axios
//       .post(`${process.env.REACT_APP_PUBLIC_API_URL}/users/suggestions`, suggestionsQuery, {
//         headers: {
//           'Content-type': 'application/json; charset=UTF-8',
//           'x-access-token': '',
//         },
