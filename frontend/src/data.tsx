...
const data = {
  menus: [
    { text: 'DashBoard', icon: <AssessmentIcon />, link: '/dashboard' },
    { text: 'Customer', icon: <PermIdentityIcon />, link: '/customers' },
    { text: 'Order', icon: <ShoppingCartCheckoutIcon />, link: '/orders' },
    { text: 'Product', icon: <StoreIcon />, link: '/products' },
    { text: 'About', icon: <InfoIcon />, link: '/about' }
  ],
  userMenus: [
    { text: 'Sign out', icon: <SettingsPowerIcon />, link: '/login' },
  ...
  dashBoardPage: {
    ...
    browserUsage: [
      { name: 'Chrome', value: 800, color: cyan600, icon: <ExpandMoreIcon /> },
      { name: 'Firefox', value: 300, color: pink600, icon: <ChevronRightIcon /> },
      { name: 'Safari', value: 300, color: purple600, icon: <ExpandLessIcon /> }
    ],
    lineBarChart: [
