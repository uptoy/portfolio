...
exports.makeParamsObject = exports.pagePathToRouteRegex = exports.encodeCaptureGroupName = exports.ROUTE_PARAMS_TYPES = void 0;
...
function encodeCaptureGroupName(string) {
    return '__encodedCaptureGroupName' + Buffer.from(string).toString('hex');
}
exports.encodeCaptureGroupName = encodeCaptureGroupName;
function decodeCaptureGroupName(string) {
    return Buffer.from(string.replace(/^__encodedCaptureGroupName/, ''), 'hex').toString();
}
...
function makeParamsObject({ routeRegexCaptureGroups, paramTypes, }) {
    const params = {};
    for (const name in routeRegexCaptureGroups) {
        ...
        if (value !== undefined) {
            ...
            if (paramType === ROUTE_PARAMS_TYPES.CATCH_ALL ||
...
exports.makeParamsObject = makeParamsObject;
