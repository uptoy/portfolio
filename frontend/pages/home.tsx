...
const useStyles: any = makeStyles(() => ({
  ...
  bgImage: {
    height: '100%',
    width: '100%',
    backgroundImage: 'http://placehold.jp/150x150.png',
...
const Home = () => {
  ...
  // const { userInfo, loaded } = HomeContainer(authContext.userData, authContext.token)
    ...
    return (
      <Box className={classes.dashboard}>
        <Box className={classes.upDivWrapper}>
          <Avatar alt="Remy Sharp" src={userInfo[0].profilePicture} className={classes.avatar} />
        ...
        <Grid container className={classes.gridWrapper}>
          <Grid item xs={12} sm={3} lg={2} className={classes.leftColumn}>
            <List>
              <ListItem button component="a" href="/dashboard/profile">
                <ListItemIcon>
                  <AccountCircleIcon className={classes.leftColumnIcon} />
                </ListItemIcon>
                <ListItemText primary="My profile" className={classes.leftColumnText} />
              </ListItem>
              <ListItem button component="a" href="/chat">
                <ListItemIcon>
                  <ChatIcon className={classes.leftColumnIcon} />
                </ListItemIcon>
                <ListItemText primary="Messages" className={classes.leftColumnText} />
              </ListItem>
              <ListItem button component="a" href="/visits">
                <ListItemIcon>
                  <VisibilityIcon className={classes.leftColumnIcon} />
                </ListItemIcon>
                <ListItemText primary="Visits" className={classes.leftColumnText} />
              </ListItem>
              <ListItem button component="a" href="/likes">
                <ListItemIcon>
                  <ThumbUpAltIcon className={classes.leftColumnIcon} />
                </ListItemIcon>
                <ListItemText primary="They liked me" className={classes.leftColumnText} />
              </ListItem>
            </List>
          </Grid>
            ...
            <Grid container spacing={5}>
              <Grid item xs={12} sm={6} className={classes.columnPaper}>
                <Paper elevation={3} className={classes.paperCTA}>
                  ...
                  <Typography className={classes.paperText}>
                    We gathered profiles that could be a good fit for you! Here's a bunch
                  </Typography>
                  <Fab size="large" color="secondary" aria-label="add" href="/suggestions">
                    <AddIcon />
                  </Fab>
                </Paper>
              </Grid>
              <Grid item xs={12} sm={6} className={classes.columnPaper}>
                <Paper elevation={3} className={classes.paperCTA}>
                  ...
                  <Typography className={classes.paperText}>
                    You can filter users according to your interests, age, distance... Have fun!
                  </Typography>
                  <Fab size="large" color="secondary" aria-label="add" href="/search">
                    <AddIcon />
                  </Fab>
                </Paper>
              </Grid>
      ...
      <Box className={classes.homeWrapper}>
        <Box className={classes.bgImage}>
          <Box className={classes.homeTextDiv}>
            ...
            <Typography>
              Start meeting new people in your area! If you already have an account, sign in to use
              Matcha.
            </Typography>
